...
func TestIdentColorForLang(t *testing.T) {
	tests := []struct {
		...
		{name: "java rejects c keyword", lang: buffer.LModeJava, ident: "sizeof", want: TextStyleDefault},
		...
		{name: "csharp rejects c type", lang: buffer.LModeCSharp, ident: "mutable", want: TextStyleDefault},
		{name: "csharp keyword delegate", lang: buffer.LModeCSharp, ident: "delegate", want: keywordStyle},
		{name: "plain text mode", lang: buffer.LModeNone, ident: "if", want: TextStyleDefault},
		{name: "markdown mode", lang: buffer.LModeMarkdown, ident: "if", want: TextStyleDefault},
	}
